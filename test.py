...
my_menu = Menu(400, 400, 50, 50, "Menu One", color=(200, 150, 0), elements=[button_one, button_two], is_visible=False)
button_three = Button(150, 50, 10, 30, my_menu.toggle_visibility, "Button 3", (170, 170, 170))
my_menu_two = Menu(250, 200, 500, 500, "Menu Two", color=(255, 255, 255), elements=[button_three])
